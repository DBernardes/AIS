...
This result is added to a noise image, created based on the noise information of the SPARC4 CCDs added to the sky flux, as a function of their operation mode. 
